    ...
    <div class="relative bg-gradient-to-b from-base-100 to-base-300">
      <div class="carousel w-full h-[450px] md:h-[600px] ">
        <div 
          ...
          @click="router.visit('/detail/'+slide.bookId+'/'+slugify(slide.bookName))"
        >
              ...
              <div class="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
                ...
                <div class="max-w-2xl text-center md:text-left " >
                  ...
                  <div class="flex gap-3 justify-center md:justify-start hidden md:block">
                    <button class="btn btn-primary btn-sm md:btn-lg gap-2" @click="router.visit('/play/'+slide.bookId+'/1/'+slugify(slide.bookName))">
                      <span class="mdi mdi-play"></span>
                      Watch Now
                    </button>
                    <button class="btn btn-outline btn-sm md:btn-lg gap-2" @click="router.visit('/detail/'+slide.bookId+'/'+slugify(slide.bookName))">
